...
<html lang=\"en\">\
<head>\
    <title data-i18n=\"app-title\">ESPuino-Konfiguration</title>\
    <meta charset=\"utf-8\">\
...
<div class=\"container\" id=\"wifiConfig\">\
    <h2 data-i18n=\"message-wifi-title\">WLAN-Konfiguration</h2>\
    <form action=\"#wifiConfig\" method=\"POST\" onsubmit=\"wifiConfig('wifiConfig'); return false\">\
        <div class=\"form-group col-md-6\">\
            <label data-i18n=\"message-wifi-ssid\" for=\"ssid\">WLAN-Name (SSID):</label>\
            <input type=\"text\" class=\"form-control\" id=\"ssid\" placeholder=\"SSID\" name=\"ssid\" required>\
            <div class=\"invalid-feedback\" data-i18n=\"enter-ssid-name\">\
                Bitte SSID des WLANs eintragen.\
            </div>\
            <label data-i18n=\"message-wifi-password\" for=\"pwd\">Passwort:</label>\
            <input type=\"password\" class=\"form-control\" id=\"pwd\" placeholder=\"Passwort\" name=\"pwd\" required>\
            <label data-i18n=\"tonuino-hostname\" for=\"hostname\">Tonuino-Name (Hostname):</label>\
            ...
            'core': {\
                ...
                'data': {\
                    ...
                    error: function (XMLHttpRequest, textStatus, errorThrown) {\
                        ...
                        toastr.error($.i18n('message-notify-file-browser-error'));\
                    }\
                },\
\
            },\
